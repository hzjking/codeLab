...
<script src="<%=request.getContextPath()%>/static/js/morris.min.js"></script>
<script src="<%=request.getContextPath()%>/static/js/raphael-2.1.0.min.js"></script>
...
<script src="<%=request.getContextPath()%>/static/js/charts.js"></script>
